package me.aarow.astatine.licence;
...
public class LicenceSystem {
    ...
    public LicenceSystem(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public LicenceSystem setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public LicenceSystem setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public LicenceSystem debug() {
        debug = true;
        return this;
    }
    ...
    public ValidationType isValid() {
        ...
        try {
            ...
            if (response.startsWith("<")) {
                ...
                return ValidationType.NOT_CONNECTED_TO_INTERNET;
            }
    ...
    public enum ValidationType {
        WRONG_RESPONSE, NOT_CONNECTED_TO_INTERNET, URL_ERROR, KEY_OUTDATED, KEY_NOT_FOUND, NOT_VALID_IP, INVALID_PLUGIN, VALID;
    }
